			...
			Spells struct{
				Spells0 struct{
					...
					Effect struct{
						...
						Effect4 struct{
							...
							Effect43 float32`json:"effect43"`
							Effect44 float32`json:"effect44"`
						}`json:"effect4"`
						Effect5 struct{
						...
						Effect6 struct{
							Effect60 float32`json:"effect60"`
							Effect61 float32`json:"effect61"`
							Effect62 float32`json:"effect62"`
							Effect63 float32`json:"effect63"`
							Effect64 float32`json:"effect64"`
						}`json:"effect6"`
						Effect7 struct{
				...
				Spells3 struct{
					...
					Effect struct{
						...
						Effect10 struct{
							Effect100 float32`json:"effect100"`
