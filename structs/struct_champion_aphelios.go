package structs
type LoLChampionAphelios struct{
			...
			Spells struct{
				...
				Spells1 struct{
					...
					Cooldown struct{
						...
						Cooldown5 float32`json:"cooldown5"`
					}`json:"cooldown"`
					CooldownBurn string`json:"cooldownBurn"`
					Cost struct{
						Cost0 int`json:"cost0"`
