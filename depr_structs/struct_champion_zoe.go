		...
		Zoe struct{
			...
			Spells struct{
				Spells0 struct{
					...
					Cooldown struct{
						Cooldown0 float32`json:"cooldown0"`
						Cooldown1 int`json:"cooldown1"`
						Cooldown2 float32`json:"cooldown2"`
						Cooldown3 int`json:"cooldown3"`
						Cooldown4 float32`json:"cooldown4"`
					}`json:"cooldown"`
				...
				Spells1 struct{
					...
					Effect struct{
						...
						Effect10 struct{
							Effect100 int`json:"effect100"`
							Effect101 float32`json:"effect101"`
							Effect102 float32`json:"effect102"`
							Effect103 float32`json:"effect103"`
							Effect104 int`json:"effect104"`
						}`json:"effect10"`
					}`json:"effect"`
					EffectBurn struct{
				...
				Spells2 struct{
					...
					Effect struct{
						...
						Effect5 struct{
							Effect50 float32`json:"effect50"`
							Effect51 float32`json:"effect51"`
							Effect52 float32`json:"effect52"`
							Effect53 float32`json:"effect53"`
							Effect54 float32`json:"effect54"`
						}`json:"effect5"`
						Effect6 struct{
							Effect60 int`json:"effect60"`
							Effect61 int`json:"effect61"`
						...
						Effect8 struct{
							Effect80 float32`json:"effect80"`
							Effect81 float32`json:"effect81"`
							Effect82 float32`json:"effect82"`
							Effect83 float32`json:"effect83"`
							Effect84 float32`json:"effect84"`
						}`json:"effect8"`
						Effect9 struct{
							Effect90 float32`json:"effect90"`
							Effect91 float32`json:"effect91"`
							Effect92 float32`json:"effect92"`
							Effect93 float32`json:"effect93"`
							Effect94 float32`json:"effect94"`
						}`json:"effect9"`
						Effect10 struct{
							Effect100 int`json:"effect100"`
							Effect101 int`json:"effect101"`
				...
				Spells3 struct{
					...
					Effect struct{
						...
						Effect1 struct{
							...
							Effect11 float32`json:"effect11"`
						...
						Effect4 struct{
							Effect40 float32`json:"effect40"`
							Effect41 float32`json:"effect41"`
							Effect42 float32`json:"effect42"`
						}`json:"effect4"`
						Effect5 struct{
							Effect50 int`json:"effect50"`
							Effect51 int`json:"effect51"`
